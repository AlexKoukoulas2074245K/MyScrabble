 ...
 * around the board
 */
public class TileSelector extends GameObject
{
	public static final int NONE_ANI = -1;
	public static final int SUCCESS_ANI = 0;
	public static final int FAILURE_ANI = 1;

	private static final String TEX_SUCCESS_ROOT_DIR = "/tiles/selection/success/";
	private static final String TEX_FAILURE_ROOT_DIR = "/tiles/selection/success/";
